...
public class MailController implements Serializable{
    ...
    public void accept(String due, String nombre) {
        ...
        try {
            ...
            addUserAprobbed(due, to, nombre, clave);
    ...
    public void addUserAprobbed(String carnet, String email, String name, String password) {
        loginSecurity s = new loginSecurity();
        s.setFormEmail(email);
        s.setFormUserName(name);
        s.setFormUser(carnet);
        s.setFormPassword(password);
        s.crearUsuario();
